			...
			<div class="inner">
				...
				<input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                    ...
                    <div class="form-radio">
                        <input type="radio" name="user_type" value="customer" id="customer" checked="checked" />
                        <label for="customer">Customer</label>

                        <input type="radio" name="user_type" value="tailor" id="tailor" />
					...
					<br>
					<h4>Already Registered?  <a href="/user_login"> Login now>> </a> </h4>
				</form>
			</div>
			<div>
